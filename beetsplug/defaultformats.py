...
class DefaultFormatsPlugin(BeetsPlugin):
    ...
    def __init__(self):
        ...
        self._log.debug("adding item field format_album (for the item's album)")
        self.template_fields['format_album'] = format_album

        self._log.debug('adding album field format_album')
        self.album_template_fields['format_album'] = format_album
        self._log.debug('adding album field format_item (alias for format_album)')
        self.album_template_fields['format_item'] = format_album
